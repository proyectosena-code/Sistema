...
import ReporteF from "./reporteF";
import "../utiles/css/reporteF.css";

const ReporteFuncionario = () => {
  return (
    <div>
      <img
        ...
        className="logo3"
      />
      <div className="Conntainer-REPORTE-F">
        <Menu />
        <div className="login-containeer">
          <div className="form-bbox login">
            ...
            <PDFDownloadLink
              document={<ReporteF />}
              fileName="Reporte_Funcionario.pdf"
            >
              {({ loading }) =>
                loading ? (
...
export default ReporteFuncionario;
