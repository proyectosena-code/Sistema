        ...
        <Document>
            <Page size={"A4"} style={styles.page}>
                ...
                <View style={styles.containerText}>
                    <Text>Registros de elementos ingresados por los funcionarios en el año 2024</Text>
                </View>
